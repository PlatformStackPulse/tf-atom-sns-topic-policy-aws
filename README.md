# tf-atom-sns-topic-policy-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-sns-topic-policy-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-sns-topic-policy-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS SNS Topic Policy - attaches a resource-based policy to a topic.
...
| <a name="input_topic_arn"></a> [topic\_arn](#input\_topic\_arn) | ARN of the SNS topic | `string` | n/a | yes |
